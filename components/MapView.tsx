...
import { nodeFeature, shortLabel, lerp, lineFeature } from "@/components/map/map-data";
import type { LngLat } from "@/components/map/map-data";
import { clusterElement, hoverCard, pillElement } from "@/components/map/map-dom";
import { MESH_DIRECT_LAYER, MESH_RELAY_LAYER } from "@/components/map/map-layers";
...
export default function MapView({
  ...
  useEffect(() => {
    ...
    // Anti-superposition : les pastilles trop proches se repoussent. Décalage
    // écran via setOffset, recalculé à chaque déplacement.
